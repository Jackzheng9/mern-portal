...
const HomeMonthlyAi = ({video, blog}) => {
  ...
  return (
    ...
    <div className="basis-0 grow-[2]">
      <a href={video.link}>
        <img src={video.image} className='rounded-2xl w-full' alt="" />
        <div className="flex gap-5 mt-4">
          <img src={GrayBar} className='' alt="" />
          <div className='pr-2'>
            <p className="text-2xl font-semibold mb-3">{video.title}</p>
    ...
    <div className="basis-0 grow-[1]">
      <a href={blog.link}>
        <img src={blog.image} className='rounded-2xl w-full' alt="" />
        <div className="flex gap-5 mt-4">
          <img src={YellowBar} className='' alt="" />
          <div className='pr-2'>
            <p className="text-2xl font-semibold mb-3">{blog.title}</p>
